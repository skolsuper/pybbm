...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Forum.updated'
        db.delete_column(u'pybb_forum', 'updated')


        # Changing field 'Post.updated'
        db.alter_column(u'pybb_post', 'updated', self.gf('django.db.models.fields.DateTimeField')())
        # Deleting field 'Topic.updated'
        db.delete_column(u'pybb_topic', 'updated')


    def backwards(self, orm):
        # Adding field 'Forum.updated'
        db.add_column(u'pybb_forum', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Post.updated'
        db.alter_column(u'pybb_post', 'updated', self.gf('django.db.models.fields.DateTimeField')(null=True))
