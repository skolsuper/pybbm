...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('pybb_forum', 'updated')
        ...
        db.alter_column('pybb_post', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Adding field 'Forum.updated'
        db.add_column('pybb_forum', 'updated',
        ...
        # Changing field 'Post.created'
        db.alter_column('pybb_post', 'created', self.gf('django.db.models.fields.DateTimeField')())
